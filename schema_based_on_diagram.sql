...
CREATE INDEX idx_treatment_medical_id ON medical_histories_treatment(treatment_id);

CREATE INDEX idx_treatment_medical_id ON medical_histories_treatment(med_history_id);